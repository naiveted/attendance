    ...
    export default {
        ...
        methods:{
        	myAbsentHistoryFunc () {
        		 var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectAllKuangKe', qs.stringify({
        	...
        	myLeaveHistoryFunc(){
        		 var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectAllLeave', qs.stringify({
                    studentid:self.personData.id,
...
//                  	});
            ...
            commitMyLeave () {
                ...
                var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/insertAttendanceByLeave', qs.stringify({
            ...
            updateData(){
                var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectAllCourseByStudent', qs.stringify({
