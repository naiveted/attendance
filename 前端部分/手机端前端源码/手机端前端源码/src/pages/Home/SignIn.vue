    ...
    created(){
      ...
      methods:{
      	delSeat(mySeatRow) {
      		 var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/deleteAttendance', qs.stringify({
                  aid: mySeatRow.aid
              }))
          ...
          checkSignIn (myRow) {
              ...
              var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/selectAttendanceByState', qs.stringify({
          ...
          updateData(){
              var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/selectByTeacher', qs.stringify({
          ...
          startSignIn (courseid) {
            ...
            axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/updateFlagById', qs.stringify({
                Flag: 1,
                courseid:courseid
            }))
                .then(function (response) {
...
//				          });
        ...
        delCheckConfirmFunc(){
        	var self = this;
            var qs = require('qs');
        	axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/deleteAbsenteeism', qs.stringify({
			                  courseid:self.courseid
			              }))
			                  .then(function (response) {
			                      self.$message({
          ...
          endSignIn (myRow) {
              var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/updateFlagClose', qs.stringify({
                  Flag: 0,
              ...
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/insertAbsenteeism', qs.stringify({
                  courseid:myRow.courseid,
