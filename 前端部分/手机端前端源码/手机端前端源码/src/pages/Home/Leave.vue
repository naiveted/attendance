...
//                
    	...
    	commitDate () {
    		var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/prosceniumPersonnelController/selectAllLeaveStudentOnDay', qs.stringify({
                  courseid: self.myRow.courseid,
                  date:self.date,
                  state:1,
              }))
...
//                    self.classContent = response.data.data;
    	...
    	updateData(){
              var self = this;
              var qs = require('qs');
              axios.post('http://47.106.173.130:8080/prosceniumCourseController/selectByTeacher', qs.stringify({
