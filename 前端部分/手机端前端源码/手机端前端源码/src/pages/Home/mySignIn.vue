    ...
    export default {
        ...
        methods:{
        	addressOkFunc(){
        		var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectInfo', qs.stringify({
...
//                  	self.commitMySingIn();
            ...
            commitMySingIn () {
                var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/insertAttendance', qs.stringify({
...
//                      }
            ...
            updateData(){
                var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectAllOpenAttendanceCourse', qs.stringify({
            ...
            nowSingIn (myRow) {
                ...
                var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectIsAttendance', qs.stringify({
                    studentid: self.teacherId,
            ...
            noValidSeatFunc(){
                ...
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumStudentController/selectOkToSeatNum', qs.stringify({
                    courseid:self.myRow.courseid,
                }))
                    .then(function (response) {
                        if(response.data.code == 200)
