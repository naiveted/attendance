        ...
        watch: {
            dialogVisible:function () {
                if(this.dialogVisible == true)
                {
                    var self = this;
                    var qs = require('qs');
                    axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/selectByOid', qs.stringify({
...
//                    }
        ...
        methods:{
        	delCourse(delCourseRow){
        		var self = this;
                var qs = require('qs');
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/deleteById', qs.stringify({
            ...
            commitData () {
                ...
                axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumCourseController/insert', qs.stringify({
                    organizationid: self.personData.organizationid,
...
//                        self.subjectContent = response.data.data;
            ...
            next() {
                ...
                if(this.active == 0){
                    ...
                    var self = this;
                    var qs = require('qs');
                    axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumClassRoomController/selectClassRoomByToUse', qs.stringify({
                        organizationid: self.personData.organizationid,
                ...
                }else if(this.active == 1)//步骤2
                {
                    var self = this;
                    var qs = require('qs');
                    axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumPersonnelController/selectAllStudent', qs.stringify({
                        organizationid: self.personData.organizationid,
                        roleid: 36,
                    }))
                        .then(function (response) {
