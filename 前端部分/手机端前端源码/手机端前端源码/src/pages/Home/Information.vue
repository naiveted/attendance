      ...
      methods:{
        ...
        updateData () {
          ...
          commitPassword () {
            ...
            else if(this.newPassword != this.newPasswordAgain)
            {
                this.$notify.error({
					...
					var self = this;
	              var qs = require('qs');
	              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumPersonnelController/updatePassword', qs.stringify({
          ...
          commitChange(){
              ...
              axios.post('http://47.106.173.130:8080/sas-manager-web/prosceniumPersonnelController/updatePersonInfo', qs.stringify({
                  id: self.personData.id,
                  age:self.age,
                  email:self.email,
